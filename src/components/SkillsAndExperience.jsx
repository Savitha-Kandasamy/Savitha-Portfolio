            ...
            <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400"></p>
             ...
             {position.techStack && position.techStack.length > 0 && (
              <div className="mt-4 mb-4">
                <p className="text-gradient font-poppins font-medium text-sm mb-3">
                  Technologies Used:
                </p>
                <div className="flex flex-wrap gap-3">
                  {position.techStack.map((tech) => (
                    <div
                      key={tech.id}
                      className="flex items-center gap-2 px-3 py-2 rounded-lg bg-black-gradient-2 border border-gray-700 hover:border-teal-200 transition-all duration-300"
                    >
                      {React.createElement(tech.icon, { className: "w-5 h-5 text-white" })}
                      <span className="text-dimWhite font-poppins text-xs">
                        {tech.name}
                      </span>
                    </div>
                  ))}
